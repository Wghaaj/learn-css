...
export default function Page() {
  return (
    <div className="max-w-screen-lg p-10">
      ...
      <Link href="/box-model" className="text-xl underline">Box Model</Link>
      ...
      <Link href="/selectors" className="text-xl underline">Selectors</Link>
      ...
      <Link href="/cascade" className="text-xl underline">The Cascade</Link>
      ...
      <Link href="/specificity" className="text-xl underline">Specificity</Link>
      ...
      <Link href="/inheritance" className="text-xl underline">Inheritance</Link>
      ...
      <Link href="/color" className="text-xl underline">Color</Link>
      ...
      <Link href="/sizing" className="text-xl underline">Sizing Units</Link>
      ...
      <Link href="/layout" className="text-xl underline">Layout</Link>
      ...
      <Link href="/flexbox" className="text-xl underline">Flexbox</Link>
      ...
      <Link href="/grid" className="text-xl underline">Grid</Link>
      ...
      <Link href="/spacing" className="text-xl underline">Spacing</Link>
      <p className="pt-2 pb-5">Explore different spacing techniques to ensure your layout looks clean and well-structured.</p>

      <Link href="/pseudo-elements" className="text-xl underline">Pseudo-elements</Link>
      ...
      <Link href="/pseudo-classes" className="text-xl underline">Pseudo-classes</Link>
      ...
      <Link href="/borders" className="text-xl underline">Borders</Link>
      ...
      <Link href="/shadows" className="text-xl underline">Shadows</Link>
      ...
      <Link href="/focus" className="text-xl underline">Focus</Link>
      ...
      <Link href="/gradients" className="text-xl underline">Gradients</Link>
      ...
      <Link href="/animations" className="text-xl underline">Animations</Link>
      ...
      <Link href="/filters" className="text-xl underline">Filters</Link>
      ...
      <Link href="/lists" className="text-xl underline">Lists</Link>
      ...
      <Link href="/transitions" className="text-xl underline">Transitions</Link>
      ...
      <Link href="/overflow" className="text-xl underline">Overflow</Link>
      ...
      <Link href="/backgrounds" className="text-xl underline">Backgrounds</Link>
      <p className="pt-2 pb-5">Explore various CSS techniques for styling backgrounds, from solid colors to complex patterns.</p>

      <Link href="/typography" className="text-xl underline">Text and Typography</Link>
