...
export default function Page() {
  return (
    <div className="max-w-screen-lg p-10">
      ...
      <Link href="#" className="text-lg underline">Box Model</Link>
      ...
      <Link href="#" className="text-lg underline">Selectors</Link>
      ...
      <Link href="#" className="text-lg underline">The Cascade</Link>
      ...
      <Link href="#" className="text-lg underline">Specificity</Link>
      ...
      <Link href="#" className="text-lg underline">Inheritance</Link>
      ...
      <Link href="#" className="text-lg underline">Color</Link>
      ...
      <Link href="#" className="text-lg underline">Sizing Units</Link>
      ...
      <Link href="#" className="text-lg underline">Layout</Link>
      ...
      <Link href="#" className="text-lg underline">Flexbox</Link>
      ...
      <Link href="#" className="text-lg underline">Grid</Link>
      ...
      <Link href="#" className="text-lg underline">Logical Properties</Link>
      ...
      <Link href="#" className="text-lg underline">Pseudo-classes</Link>
      ...
      <Link href="#" className="text-lg underline">Borders</Link>
      ...
      <Link href="#" className="text-lg underline">Shadows</Link>
      ...
      <Link href="#" className="text-lg underline">Focus</Link>
      ...
      <Link href="#" className="text-lg underline">Gradients</Link>
      ...
      <Link href="#" className="text-lg underline">Animations</Link>
      ...
      <Link href="#" className="text-lg underline">Filters</Link>
      ...
      <Link href="#" className="text-lg underline">Lists</Link>
      ...
      <Link href="#" className="text-lg underline">Transitions</Link>
      ...
      <Link href="#" className="text-lg underline">Overflow</Link>
      ...
      <Link href="#" className="text-lg underline">Backgrounds</Link>
      <p className="pt-2 pb-5">Explore various CSS techniques for styling backgrounds, from solid colors to complex patterns.</p>

      <Link href="#" className="text-lg underline">Text and Typography</Link>
